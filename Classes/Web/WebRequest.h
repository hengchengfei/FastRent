...
+(void)getFilterInfo:(void(^)(ComboxVo *bo,NSError *error))onCompletion;

+(void)getListNearby:(NSDictionary *)location filterparams:(NSDictionary *)filterparams page:(NSInteger)page complete:(void(^)(HouseVo *bo,NSError *error))onCompletion;

+(void)getListSearch:(NSDictionary *)location filterparams:(NSDictionary *)filterparams page:(NSInteger)page complete:(void(^)(HouseVo *bo,NSError *error))onCompletion;
